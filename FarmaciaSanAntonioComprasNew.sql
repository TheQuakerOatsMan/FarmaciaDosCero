...
CREATE alter PROC DETCAME @cvecad INT
	,@cvemed INT
	,@lote VARCHAR(10)
	,@clave int
	,@BAN INT OUTPUT
...
CREATE alter PROC BAJAPROVTEMP
@CVEPROV INT
,@clave int 
,@BAN INT OUTPUT
AS
...
CREATE alter PROC BAJADETCOMMED
@CVECOMP INT
,@CVEMED INT
,@clave int 
,@BAN INT OUTPUT
...
--------------------------------------------------------
CREATE alter PROC BAJADETCOMPRO
@CVECOMP INT,
@CVEPROD INT,
@clave int, 
@BAN INT OUTPUT
...
CREATE alter PROC BAJAPRODTEMP
@CVEPROD INT
,@clave int
,@BAN INT OUTPUT
AS
...
CREATE alter PROC MODGANANCIAMED
@CVEMED INT,
@GANANCIA MONEY
,@clave int
,@BAN INT OUTPUT
...
CREATE alter PROC MODGANANCIAPROD
@CVEPROD INT
,@GANANCIA MONEY
,@clave int 
,@BAN INT OUTPUT
